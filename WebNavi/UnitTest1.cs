...
namespace WebNavi
{
    ...
    public class UnitTest1
    {
        ...
        public void TChromeDriver()
        {
            ...
            //To assert if the Laptop price is greater than 100$
            //Test should pass if the price is greater than 100$
            //Test should fail if price is less than or equal to 100$
